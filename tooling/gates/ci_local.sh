...
MOVI_ALLOW_HOST_EXECUTION=1 LINT_FRONTEND_SKIP_GEMINI_AUDIT=1 bash tooling/gates/lint_frontend.sh
...
MOVI_ALLOW_HOST_EXECUTION=1 bash tooling/gates/functional_gate.sh
