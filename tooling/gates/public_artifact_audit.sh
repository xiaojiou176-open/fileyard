...
"$PYTHON_BIN" "$ROOT/scripts/check_public_asset_provenance.py" --root "$REPO_ROOT"
"$PYTHON_BIN" "$ROOT/scripts/check_public_artifact_safety.py" --root "$REPO_ROOT"

echo "✅ public_artifact_audit: passed"
