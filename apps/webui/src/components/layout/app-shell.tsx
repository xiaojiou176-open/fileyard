...
function getDocumentMetadata(pathname: string): { title: string; description: string } {
  const fallback = {
    title: 'Fileman | Review-first local organizer',
    description:
      'Fileman is a review-first local file organizer and workbench with AI-assisted planning, dry-run-first execution, and rollback-ready recovery.',
  }
  ...
  if (pathname.startsWith('/manifest')) {
    return {
      title: 'Manifest Workbench | Fileman',
  ...
  if (pathname.startsWith('/rollback')) {
    return {
      title: 'Rollback | Fileman',
      description: 'Rollback stays bounded, deterministic, and auditable inside the same local-first workflow.',
    }
  }
  if (pathname.startsWith('/inbox')) {
    return {
      title: 'Fileman Inbox | Fileman',
      description: 'Scan intake batches, pick a Strategy Pack, and hand the batch into Analyze without turning Fileman into an autonomous organizer.',
    }
  }
  return fallback
}
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto grid w-full max-w-[1720px] grid-cols-1 gap-0 lg:grid-cols-[296px_1fr] lg:px-4">
            ...
            <div className="workspace-panel p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1">
                  <p className="workspace-kicker">Fileman</p>
        ...
        <div className="min-h-screen px-4 pb-8 pt-4 sm:px-6 lg:px-10">
          ...
          <main>
            <h1 className="sr-only">Fileman Review-First Workspace</h1>
            <Outlet />
          </main>
        </div>
      </div>
