...
const DASHBOARD_DOC_LINKS = {
  codex: 'https://github.com/xiaojiou176-open/fileman/blob/main/docs/codex_mcp.md',
  claude: 'https://github.com/xiaojiou176-open/fileman/blob/main/docs/claude_code_mcp.md',
  mcp: 'https://github.com/xiaojiou176-open/fileman/blob/main/docs/mcp.md',
  developerGuide: 'https://github.com/xiaojiou176-open/fileman/blob/main/docs/developer_guide.md',
} as const
